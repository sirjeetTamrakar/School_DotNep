...
@section('headers')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h5 class="page-title"> Testimonial </h5>
        </div>
    </div>
    <!-- end row -->
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">Testimonial List<button type="button" class="btn btn-primary waves-effect waves-light float-right" data-toggle="modal" data-target=".edu-add-new">Add New</button></h4>
                        @include('admin.testimonial.add')
...
<script>
    $(document).ready(function () {
        $('#datatable-students').DataTable({
            ...
            bInfo: false,
            bAutoWidth: false,
            ajax: "{{ route('admin.testimonial.json') }}",
            columns: [
                {
                    data: 'count',
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function (data, type, row) {
                        var tempDeleteUrl = "{{ route('admin.testimonial.delete', ':id') }}";
...
<script>
    $(document).on("click", ".btn-edit-row", function (e) {
        ...
        var tempEditUrl = "{{ route('admin.testimonial.edit', ':id') }}";
