        ...
        <div class="col-sm-12">
            <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.tender.all') }}">Tender</a></li>
                </ol>
            </div>
            <h5 class="page-title">{{ getLanguage('tender') }}</h5>
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title text-center">{{ getLanguage('school').' '.getLanguage('tender') }}</h4>
                    <div>
                        <a href="{{ route('admin.tender.add') }}" class="pull-right btn btn-primary">
                            {{ getLanguage('add-new').' '.getLanguage('tender') }}</a>
                    </div>
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$content->title}}</td>
                                <td>
                                    <a href="{{route('admin.tender.changestatus',$content->id)}}">
                                ...
                                <td>
                                    ...
                                    @include('admin.tender.details')

                                    <a href="{{ route('admin.tender.edit',$content->slug) }}" class="btn btn-success btn-icon-text mr-2 p-1" title="Edit">
