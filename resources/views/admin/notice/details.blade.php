    ...
    <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel">{{ getLanguage('notice').' '.getLanguage('title') }} : {{$content->title}}t</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <strong>{{ getLanguage('notice').' '.getLanguage('image') }}:</strong>
                        </div>
                        <div class="col-md-10">
